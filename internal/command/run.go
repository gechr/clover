...
type cmdRun struct {
	...
	Enable     []string     `            help:"Resolve only these providers, skipping all others"                                         clib:"terse='Enable providers',group='Options/Selection/2'"                   placeholder:"<provider>"`
	Disable    []string     `            help:"Skip these providers, resolving all others"                                                clib:"terse='Disable providers',group='Options/Selection/2'"                  placeholder:"<provider>"`
