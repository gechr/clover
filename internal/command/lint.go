...
type cmdLint struct {
	...
	Tags     []string     `name:"tag"  help:"Only check directives matching these tags"                    clib:"terse='Filter by tags',group='Options/Selection'"                  short:"t" aliases:"tags" placeholder:"<tag>"`
